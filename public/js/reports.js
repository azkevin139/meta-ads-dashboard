          ...
          <tbody>
            ${creatives.length ? creatives.map((row, index) => `
              <tr>
                ...
                <td class="right">${fmt(row.spend, 'currency')}</td>
                <td class="right">${fmt(row.clicks, 'integer')}</td>
                <td class="right">${fmt(row.total_leads, 'integer')}</td>
                <td class="right">${fmt(row.cpl, 'currency')}</td>
                <td class="right">${fmt(row.qualified_leads, 'integer')}</td>
                <td class="right">${fmt(row.booked_count, 'integer')}</td>
                <td class="right">${fmt(row.won_count, 'integer')}</td>
              </tr>
